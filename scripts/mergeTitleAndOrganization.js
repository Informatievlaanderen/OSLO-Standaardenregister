    ...
    return new Promise(function (resolve, reject) {
        fs.readFile(fullPath, 'utf8', function (err, data) {
            ...
            try {
                ...
                var extract = extractTitleAndOrganization(content);
                resolve(extract);
            }
            catch (parseError) {
...
var processDirectory = function (dirPath) { return __awaiter(_this, void 0, void 0, function () {
    var dirents, promises, _i, dirents_1, dirent, fullPath, results, outputs;
