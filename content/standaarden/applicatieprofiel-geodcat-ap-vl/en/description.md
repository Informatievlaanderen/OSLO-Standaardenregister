The applications covered by this profile are catalogues of descriptions of geographical data that are created by transforming catalogues described according to the ISO (INSPIRE) agreements.

This application profile is a further refinement of the agreements made in the <a href="https://data.vlaanderen.be/standaarden/applicatieprofiel-dcat-ap-vl">application profile DCAT-AP VL (version 3).</a>
